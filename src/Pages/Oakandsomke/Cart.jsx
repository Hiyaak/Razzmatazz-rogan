    ...
    <div className="flex flex-col md:flex-row min-h-screen">
      ...
      <div className="w-full md:w-2/5 bg-gray-50 min-h-screen border-r border-gray-200 flex flex-col">
        ...
        <div className="flex-1 p-6">
          {/* Promotions Section */}
          <div className="mb-8">
            <h2 className="text-lg font-medium text-gray-900 mb-4">Promotions</h2>
          ...
          <div className="mb-8">
            <h2 className="text-lg font-medium text-gray-900 mb-4">Special Remarks</h2>
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                <input type="checkbox" className="w-4 h-4 text-orange-500 rounded" />
                <span className="text-gray-700">Enter your Special Remarks</span>
              </div>
              <div className="flex items-center space-x-3">
                <input type="checkbox" className="w-4 h-4 text-orange-500 rounded" />
                <span className="text-gray-700"></span>
